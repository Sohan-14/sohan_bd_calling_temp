...
import 'package:sohan_bd_calling_temp/app/widgets/accept_terms_condition_layout.dart';
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  const AuthScreenTitleSection(title: AppStrings.signUpTitle, subTitle: AppStrings.signUpSubTitle),
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          InputLayout(
                            isLabelLarge: true,
                            isBorder: true,
                            validator: (dynamic value) => AppValidation.validateName(value),
                            inputLabel: AppStrings.usernameLabel,
                  ...
                  CustomButton(
                      onTap: (){
                        if(formKey.currentState!.validate()){
                          Get.toNamed(AppScreens.verifyEmailRoute, arguments: <String, dynamic>{
                            AppConstants.viewsType: ViewsType.HOME
                          });
                        }
                      },
                  ...
                  CustomRichText(
                    firstLabel: AppStrings.alreadyHaveAcc,
                    secondLabel: AppStrings.signIn,
                    onPress: () => Get.offNamed(AppScreens.signInRoute),
                  ),
